...
class Edit extends Component {
  ...
  validatePhoneNumber = () => {
    ...
    if (regexname.test(this.state.phoneNumber) == 0) {
      alert("validation error");
      this.props.history.push();
      return false;
    }
  ...
  validateBirthDate = () => {
    ...
    if (regexname.test(this.state.birthDate) == 0) {
      alert("validation error");
      this.props.history.push();
      return false;
    }
      ...
      <body className="register">
        ...
        <div className="container">
          ...
          <div className=" smx-sm-3 mb-2">
            ...
            <button
              className="btn btn-primary mb-2 btn-danger"
              onClick={this.onClickPhoneNumber.bind(this)}
            >
              Edit Phone Number
            </button>
          </div>
          ...
          <div className="mx-sm-3 mb-2">
            ...
            <button
              className="btn btn-primary mb-2 btn-danger"
              onClick={this.onClickBirthDate.bind(this)}
            >
              Edit Birth Date
            </button>
          </div>
